...
import 'package:tugas_dpl/controllers/home_controller.dart';
import 'package:tugas_dpl/models/alumni_model.dart';
...
class StubAlumniRepository implements AlumniRepository {
  ...
  Future<void> deleteAlumni(String nobp) async {
    _dataAlumni.removeWhere((a) => a.nobp == nobp);
  }
}
...
void main() {
  ...
  test('Test 1: Load alumni berhasil mengambil data', () async {
    ...
    expect(controller.alumniList[0].name, "Catur Rahmani Oktavia");
  });
  ...
  test('Test 3: Hapus alumni berhasil berdasarkan nobp', () async {
    StubAlumniRepository stubRepo = StubAlumniRepository();
    HomeController controller = HomeController(repository: stubRepo);
